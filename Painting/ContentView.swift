...
//                }.fill(Color(red: 0.924, green: 0.303, blue: 0.291)).offset(x: -120, y: 228)
            ...
            }.stroke(Color(red: 0.224, green: 0.224, blue: 0.223),lineWidth: 0.6).offset(x: -120, y: 228)
                //
...
//                face.closeSubpath()
                ...
                face.addQuadCurve(to: CGPoint(x:382,y:99), control: CGPoint(x:380,y:110))//右耳
                face.addQuadCurve(to: CGPoint(x:370,y:111), control: CGPoint(x:373,y:103))//右耳
                }.stroke(Color(red: 0.224, green: 0.224, blue: 0.223)).offset(x: -120, y: 228)
            ...
            }.stroke(Color(red: 0.224, green: 0.224, blue: 0.223),lineWidth: 1.8).offset(x: -120, y: 228)
            ...
            }.stroke(Color(red: 0.224, green: 0.224, blue: 0.223),lineWidth: 1.2).offset(x: -120, y: 228)
